      ...
      <div class='row px-xl-5 pt-5'>
        <div class='col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5'>
          <a href='' class='text-decoration-none'>
            <h1 class='primary-color mb-4 display-5 font-weight-semi-bold'>
              <span class='font-weight-bold primary-color bg-white border border-white px-3 mr-1'>
                S
              </span>
              martBuy
            </h1>
          ...
          <div class='row'>
            ...
            {/* <div class='col-md-4 mb-5'>
              ...
              <form action=''>
                ...
                <div>
                  <button
                    class='ubtn-primary back-primary color-white btn-block border-0 py-3'
                    type='submit'
                  >
                    Subscribe Now
                  </button>
